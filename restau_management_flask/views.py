...
import os
from .forms import AddGroupForm, ReleaseGroupTable
...
def add_group():
  ...
  return render_template("groups.html", form=form, form2=form2, customer_groups=r.customer_groups, free_tables=r.free_tables)
